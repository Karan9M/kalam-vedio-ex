...
// Spring-in + fade image, optional fade-out
...
// Fade + slide-up reveal for any content block
...
// Pop-scale reveal for numbers / formulas
...
// Consistent numbered slide header
export const SlideBase: React.FC<{
  ...
  <AbsoluteFill style={{ backgroundColor: C.bg, padding: `${padTop}px 88px 48px` }}>
    <Reveal at={0} style={{ display: "flex", alignItems: "center", gap: 26, marginBottom: 38 }}>
      <div style={{
      ...
      <div style={{ fontSize: 56, fontWeight: 800, color: C.title, fontFamily: F, lineHeight: 1 }}>
        {title}
      </div>
    </Reveal>
    {children}
...
// Colored pill box (used for E/O labels)
export const Pill: React.FC<{ color: string; bg: string; border: string; children: React.ReactNode; size?: number }> = ({
...
// Row helper
export const Row: React.FC<{ gap?: number; align?: string; style?: CSSProperties; children: React.ReactNode }> = ({
